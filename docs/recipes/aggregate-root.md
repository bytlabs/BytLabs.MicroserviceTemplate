...
- [`Order.cs`](../../src/BytLabs.MicroserviceTemplate.Domain/Orders/Aggregates/Order.cs) — minimal aggregate
- [`Product.cs`](../../src/BytLabs.MicroserviceTemplate.Domain/Products/Aggregates/Product.cs) — advanced aggregate
