...
- [`Product.cs`](../../src/BytLabs.MicroserviceTemplate.Domain/Products/Aggregates/Product.cs) — `Update`, `AddVariant`, `RemoveVariant`, `Remove`
- [`EntityDef.cs`](../../src/BytLabs.MicroserviceTemplate.Domain/EntityDefs/Aggregates/EntityDef.cs) — `Update` replaces form + table schemas
